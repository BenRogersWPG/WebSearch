...
function activate(context) {
    ...
    function performWebSearch() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let text = (_a = vscode.window.activeTextEditor) === null || _a === void 0 ? void 0 : _a.document.getText(editor.selection);
            let manualSearch = vscode.workspace.getConfiguration('webSearch').get('allowManualSearch');
